...
function transformNumberToCurrencyString(number) {
...
export function HeaderMenu({ layoutProps }) {
  ...
  const agencyCredit = transformNumberToCurrencyString(user.groupId.credit);
  // const agencyCredit = user.groupId?.credit 
  ...
  return (
    ...
    >
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        >
          <span className="mr-2" style={{ fontWeight: '500', fontSize: 14 }}>
             <span style={{fontWeight:'bold'}} className="text-primary">{agencyCredit}</span> Message credit.
          </span>
        </li>
        {/*end::1 Level*/}
