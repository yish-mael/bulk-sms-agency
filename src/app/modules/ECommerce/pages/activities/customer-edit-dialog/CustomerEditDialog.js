...
export function CustomerEditDialog({ id, show, onHide }) {
  ...
  const { actionsLoading, error, userForEdit, agencyError, agencies } = useSelector(
    (state) => ({
  ...
  useEffect(() => {
    ...
    // dispatch(agencyActions.fetchCustomers(usersUIProps.queryParams))
  }, [id, dispatch]);
    ...
    >
      ...
      >
        ...
        <Tab eventKey="agency" title="Add Agency">
          <AgencyEditForm saveAgency={saveAgency} />
        </Tab>
      </Tabs>
