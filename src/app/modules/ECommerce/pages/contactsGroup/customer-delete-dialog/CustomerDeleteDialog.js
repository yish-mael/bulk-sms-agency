...
export function CustomerDeleteDialog({ id, show, onHide }) {
        ...
        setSnackbar({
          ...
          message: (
            <p style={{ fontSize: '16px' }}>
              {!error ? `Contact group deleted successfully!` : error}
            </p>
          ),
          show: true,
        })
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        {!isLoading && (
          <span>Are you sure to permanently delete this contact group?</span>
        )}
        {isLoading && <span>Contact group is deleting...</span>}
      </Modal.Body>
      <Modal.Footer>
        <div>
          <button
