...
export function ContactsTable({ show, onHide }) {
  // Messages UI Context
  ...
  const { totalCount, allContacts, listLoading } = currentState;
  ...
  useEffect(() => {
    ...
    dispatch(
      actions.unPaginatedfetchCustomers({
